...
$BarCsvPath = "C:\TradeData\futuresbot\live\MNQ_1m_live.csv"
$TradeLiveDir = "C:\TradeData\futuresbot\live"
...
# --- 2. Trade data paths ---
Write-Host "`n[2/6] Creating trade data directories..."
New-Item -ItemType Directory -Path $TradeLiveDir -Force | Out-Null
New-Item -ItemType Directory -Path $ArchiveRoot -Force -ErrorAction SilentlyContinue | Out-Null
Write-Host "  Bar CSV target: $BarCsvPath"
...
Write-Host ""
Write-Host "Ensure NinjaTrader/futuresbot writes: $BarCsvPath"
